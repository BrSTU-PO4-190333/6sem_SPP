...
\begin{document}
    ...
    \lstinputlisting[language=xml, name=src/main/resources/com/example/../View-Table-UnitMeasure.fxml]
    {../sources/src/main/resources/com/example/spp_2sem_po4_galanin_lab4/View-Table-UnitMeasure.fxml}

    \lstinputlisting[language=java, name=src/main/java/com/example/../ControllerTableUnitMeasure.java]
    {../sources/src/main/java/com/example/spp_2sem_po4_galanin_lab4/ControllerTableUnitMeasure.java}


    \lstinputlisting[language=xml, name=src/main/resources/com/example/../View-Form-UnitMeasure.fxml]
    {../sources/src/main/resources/com/example/spp_2sem_po4_galanin_lab4/View-Form-UnitMeasure.fxml}

    \lstinputlisting[language=java, name=src/main/java/com/example/../ControllerFormUnitMeasure.java]
