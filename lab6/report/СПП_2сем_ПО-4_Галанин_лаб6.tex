...
\begin{document}
    ...
    \lstinputlisting[language=java, name=src/main/java/com/example/tictactoeclientgui/Main_1.java]
    {../sources/TicTacToeClientGUI/src/main/java/com/example/tictactoeclientgui/Main_1.java}
    \lstinputlisting[language=java, name=src/main/java/com/example/tictactoeclientgui/HelloApplication.java]
    {../sources/TicTacToeClientGUI/src/main/java/com/example/tictactoeclientgui/HelloApplication.java}
    \lstinputlisting[language=java, name=src/main/java/com/example/tictactoeclientgui/HelloController.java]
    {../sources/TicTacToeClientGUI/src/main/java/com/example/tictactoeclientgui/HelloController.java}
    \lstinputlisting[language=java, name=src/main/java/com/example/tictactoeclientgui/TicTacToeGame.java]
    {../sources/TicTacToeClientGUI/src/main/java/com/example/tictactoeclientgui/TicTacToeGame.java}
    \lstinputlisting[language=java, name=src/main/java/com/example/tictactoeclientgui/GameController.java]
    {../sources/TicTacToeClientGUI/src/main/java/com/example/tictactoeclientgui/GameController.java}
    \lstinputlisting[language=xml, name=src/main/resources/com/example/tictactoeclientgui/hello-view.fxml]
    {../sources/TicTacToeClientGUI/src/main/resources/com/example/tictactoeclientgui/hello-view.fxml}
    \lstinputlisting[language=xml, name=src/main/resources/com/example/tictactoeclientgui/game-view.fxml]
